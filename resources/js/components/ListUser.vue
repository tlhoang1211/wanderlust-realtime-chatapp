<template>
    <div class="card mb-sm-3 mb-md-0 contacts_card">
        <div class="card-header">
            <h3 class="d-flex" style="color: rgb(255, 240, 31)">Online<span
                class="badge ml-2 users-online">{{ usersOnline.length }}</span>
            </h3>
            ...
            <div class="contacts">
                <li v-for="user in filteredUsersList" :key="user.id" @click="$emit('selectReceiver', user)">
                    ...
                    <div class="d-flex bd-highlight">
                        <div class="img_cont">
                            <img
                                :src="user.id === $root.user.id ? '/images/current_user.webp' : '/images/other_user.webp'"
